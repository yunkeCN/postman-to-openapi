...
const OUTPUT_PATH = path.join(__dirname, "/openAPIRes.json")
...
const EXPECTED_BASIC = readFileSync("./test/resources/output/Basic.json", "utf8")
const EXPECTED_INFO_OPTS = readFileSync("./test/resources/output/InfoOpts.json", "utf8")
const EXPECTED_NO_VERSION = readFileSync("./test/resources/output/NoVersion.json", "utf8")
const EXPECTED_CUSTOM_TAG = readFileSync("./test/resources/output/CustomTag.json", "utf8")
const EXPECTED_FOLDERS = readFileSync("./test/resources/output/Folders.json", "utf8")
const EXPECTED_FOLDERS_NO_CONCAT = readFileSync("./test/resources/output/FoldersNoConcat.json", "utf8")
const EXPECTED_FOLDERS_SEPARATOR = readFileSync("./test/resources/output/FoldersSeparator.json", "utf8")
const EXPECTED_GET_METHODS = readFileSync("./test/resources/output/GetMethods.json", "utf8")
const EXPECTED_HEADERS = readFileSync("./test/resources/output/Headers.json", "utf8")
const EXPECTED_AUTH_BEARER = readFileSync("./test/resources/output/AuthBearer.json", "utf8")
const EXPECTED_AUTH_BASIC = readFileSync("./test/resources/output/AuthBasic.json", "utf8")
const EXPECTED_BASIC_WITH_AUTH = readFileSync("./test/resources/output/BasicWithAuth.json", "utf8")
const EXPECTED_AUTH_MULTIPLE = readFileSync("./test/resources/output/AuthMultiple.json", "utf8")
const EXPECTED_PATH_PARAMS = readFileSync("./test/resources/output/PathParams.json", "utf8")
const EXPECTED_MULTIPLE_SERVERS = readFileSync("./test/resources/output/MultipleServers.json", "utf8")
const EXPECTED_SERVERS_OPTIONS = readFileSync("./test/resources/output/ServersOpts.json", "utf8")
const EXPECTED_NO_SERVERS = readFileSync("./test/resources/output/NoServers.json", "utf8")
const EXPECTED_LICENSE_CONTACT = readFileSync("./test/resources/output/LicenseContact.json", "utf8")
const EXPECTED_LICENSE_CONTACT_OPT = readFileSync("./test/resources/output/LicenseContactOpts.json", "utf8")
const EXPECTED_LICENSE_CONTACT_PARTIAL = readFileSync("./test/resources/output/LicenseContactPartial.json", "utf8")
const EXPECTED_LICENSE_CONTACT_PARTIAL_2 = readFileSync("./test/resources/output/LicenseContactPartial2.json", "utf8")
const EXPECTED_DEPTH_PATH_PARAMS = readFileSync("./test/resources/output/DepthPathParams.json", "utf8")
const EXPECTED_PARSE_STATUS_CODE = readFileSync("./test/resources/output/ParseStatus.json", "utf8")
const EXPECTED_NO_PATH = readFileSync("./test/resources/output/NoPath.json", "utf8")
const EXPECTED_DELETE = readFileSync("./test/resources/output/DeleteOperation.json", "utf8")
const EXPECTED_URL_WITH_PORT = readFileSync("./test/resources/output/UrlWithPort.json", "utf8")
const EXPECTED_EXTERNAL_DOCS = readFileSync("./test/resources/output/ExternalDocs.json", "utf8")
const EXPECTED_EXTERNAL_DOCS_OPTS = readFileSync("./test/resources/output/ExternalDocsOpts.json", "utf8")
const EXPECTED_EXTERNAL_DOCS_OPTS_PARTIAL = readFileSync("./test/resources/output/ExternalDocsOptsPartial.json", "utf8")
const EXPECTED_EMPTY_URL = readFileSync("./test/resources/output/EmptyUrl.json", "utf8")
const EXPECTED_X_LOGO = readFileSync("./test/resources/output/XLogo.json", "utf8")
const EXPECTED_X_LOGO_VAR = readFileSync("./test/resources/output/XLogoVar.json", "utf8")
const EXPECTED_AUTH_OPTIONS = readFileSync("./test/resources/output/AuthOptions.json", "utf8")
const EXPECTED_RESPONSES = readFileSync("./test/resources/output/Responses.json", "utf8")
const EXPECTED_RESPONSES_MULTI_LANG = readFileSync("./test/resources/output/ResponsesMultiLang.json", "utf8")
const EXPECTED_AUTH_REQUEST = readFileSync("./test/resources/output/AuthRequest.json", "utf8")
const EXPECTED_RESPONSES_NO_HEADERS = readFileSync("./test/resources/output/ResponsesNoHeaders.json", "utf8")
const EXPECTED_FORM_DATA = readFileSync("./test/resources/output/FormData.json", "utf8")
const EXPECTED_FORM_URLENCODED = readFileSync("./test/resources/output/FormUrlencoded.json", "utf8")
const EXPECTED_VARIABLES = readFileSync("./test/resources/output/Variables.json", "utf8")
const EXPECTED_VARIABLES_ADDITIONAL = readFileSync("./test/resources/output/VariablesAdditional.json", "utf8")
const EXPECTED_BASEPATH_VAR = readFileSync("./test/resources/output/BasepathVar.json", "utf8")
const EXPECTED_RAW_BODY = readFileSync("./test/resources/output/RawBody.json", "utf8")
const EXPECTED_NULL_HEADER = readFileSync("./test/resources/output/NullHeader.json", "utf8")
const EXPECTED_COLLECTION_WRAPPER = readFileSync("./test/resources/output/CollectionWrapper.json", "utf8")
